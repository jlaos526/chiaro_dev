...
describe('FederalLeadershipList — mode awareness', () => {
  it('renders under both light and dark wrappers without throwing', () => {
    ...
    expect(() => render(<FederalLeadershipList rows={rows} />, { wrapper: lightWrapper })).not.toThrow()
    expect(() => render(<FederalLeadershipList rows={rows} />, { wrapper: darkWrapper })).not.toThrow()
  })
})
