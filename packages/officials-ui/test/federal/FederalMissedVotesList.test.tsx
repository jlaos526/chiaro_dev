...
describe('FederalMissedVotesList — mode awareness', () => {
  it('renders under both light and dark wrappers without throwing', () => {
    ...
    expect(() => render(<FederalMissedVotesList rows={rows} />, { wrapper: lightWrapper })).not.toThrow()
    expect(() => render(<FederalMissedVotesList rows={rows} />, { wrapper: darkWrapper })).not.toThrow()
  })
})
