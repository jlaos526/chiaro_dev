// Slice 78 (audit C26): the mobile Settings "Privacy policy" row pushed
// /legal/privacy while NO such mobile route existed — an as-never cast hid
    ...
    <>
      ...
      <SettingsScreen title="Privacy Policy">
        ...
        >
          ...
          <Text style={{ color: semantic.text.body, fontSize: 14, lineHeight: 20 }}>
            We store the email address you sign up with, the home address you calibrate to (to look
            up your elected officials), and the elected-officials pages you view. We don't sell your
