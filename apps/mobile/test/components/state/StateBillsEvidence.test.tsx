...
describe('mobile StateBillsEvidence', () => {
  ...
  it('shows top N (5) + "show more" toggle for 8 bills', () => {
    ...
    const showMore = getByText(/show more/i)
    expect(showMore).toBeTruthy()
    // Expand and confirm previously-hidden rows render.
    fireEvent.press(showMore)
    expect(getByText(/Bill 7/)).toBeTruthy()
  })
})
