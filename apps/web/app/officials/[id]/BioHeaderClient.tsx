...
export function BioHeaderClient(props: Omit<BioHeaderProps, 'onChipPress' | 'chipHref'>): React.JSX.Element {
  ...
  return (
    <BioHeader
      ...
      chipHref={(chip) =>
        `/officials/${props.officialId}#issue-positions:${chip.subCascadeSlug}`
      }
    />
  )
}
