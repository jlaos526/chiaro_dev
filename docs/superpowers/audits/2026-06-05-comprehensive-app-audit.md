...
|---|---|---|---|
| **T1 — Security & data-integrity hardening** | A1–A5 | Compressed Slice | 1 append-only migration + pgTAP + revoke + 2 CHECKs + search_path. **Recommended first** — verified, small, security. |
| **T2 — State-card correctness + detail-page a11y** | B3, B4, B5, B6, B9, C1, C2, C3, C4 | Mega Slice | The state-card NULL/loading bugs + the project-wide card-heading gap. Highest user-facing quality lift. |
